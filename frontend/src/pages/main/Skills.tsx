...
const Skills: React.FC = () => {
    return (
        <div className="flex h-screen min-h-[912px] w-screen items-center justify-center bg-dark-gray bg-[radial-gradient(#fcfbf4,transparent_2px)] [background-size:32px_32px]">
            <div className="flex max-h-screen flex-row items-center justify-center text-cream-white drop-shadow-2xl md:h-auto md:w-3/5 md:min-w-max md:border-4 md:border-cream-white md:bg-dark-gray md:px-10 md:pb-10">
